...
## *"Plans are nothing; planning is everything”*, President & US General, Dwight D Eisenhower (1890-1969)
...
Delete the example text on the page, then copy & paste the plan above.  Click the ```Submit``` button.  Your plan will be displayed!

Notice that the plan is too wide to fit on the page.  Currently the scale is assumed to be the default, daily.  The scale can be changed from daily to weekly, monthly, quarterly and even yearly.  Let's change the scale on this plan to weekly.  We can add the line anywhere, below the projectscale line has been added just below the title, near the top.
