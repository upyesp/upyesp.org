---
title: "Windows SSH To Remote Server With FIDO2 or TOTP Multi Factor Authentication MFA / 2FA"
description: Use the latest version of OpenSSH in Windows for more secure authentication. 
date: 2023-05-30T08:34:00+01:00
draft: true
toc: true
pinned: false
featuredImage: ''
...
Windows ships with OpenSSH.  Here's how to update the version then use it with MFA options, including FIDO2 + hardware security keys (Yubikey) or Timed One Time Passwords (TOTP) + authenticator apps.
...
> 1. SSH to the server, with: `ssh sam@server21`.
...
## Multifactor Authentication - FIDO2 With A Hardware Security Key, Like YubiKey
...
You might want to add to this and use the following optional parameteres:
...
## Multifactor Authentication - TOTP + Authenticator Apps
